...
/**
 * Class representing ExpensesClassificationDocAType
 */
class ExpensesClassificationDocAType
{
    /**
     ...
     * @return self
     */
    public function setExpensesInvoiceClassification(array $expensesInvoiceClassification = null)
    {
        $this->expensesInvoiceClassification = $expensesInvoiceClassification;
        return $this;
    }
